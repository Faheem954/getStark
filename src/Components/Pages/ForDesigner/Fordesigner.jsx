...
<p>For Designers</p>
<h1>Accessible,</h1>
<h1 style={{marginTop:"0%",marginLeft:"20%"}}> by design</h1>
<div className='forDesigner-home-1-p2'>Stark helps eliminate up to 100% of the accessibility issues originating in design. Our AI-powered Sidekick experience combined with our best-in-class manual tools helps every designer find and fix accessibility issues within seconds. And hand over fully annotated designs to developers.</div>
...
<div className="forDesigner-home-2-img2">
  <img  src="https://images.getstark.co/marketing/headers/for-designers.webp"></img>
</div>
</div>

</div>   
<img style={{marginTop:"5%",marginLeft:"10%"}} height="70%" width="80%" src="https://images.getstark.co/marketing/features/for-designers-checkfixannotate.webp"></img>

<div className="forDesigner-home3">
<h2 className='forDesigner-home3-h2-1'> <h2 className='forDesigner-home3-h2-1-2'><span>Find and fix accessibility issues</span></h2>
</h2>
<h2 className='forDesigner-home3-h2-2'>in designs 10x faster with AI</h2>
<p className='forDesigner-home3-h2-p'>
