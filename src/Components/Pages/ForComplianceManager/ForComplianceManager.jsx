...
<p style={{fontSize:'1.6rem'}}>FOR COMPLIANCE MANAGERS</p>
<h1 ></h1>
<div className='forDesigner-home-1-p2'>Managing digital accessibility compliance requires the same level of rigor and prioritization as security and privacy. With Stark’s Compliance Center, managing your accessibility posture and growing your company’s accessibility maturity becomes centralized, actionable, automate.</div>
...
<div className="forDesigner-home-2-img2">
  <img  src="https://images.getstark.co/marketing/headers/for-compliancemanagers.webp?updatedAt=1705500823824"></img>
</div>
</div>

</div>   
<img style={{marginTop:"5%",marginLeft:"10%"}} height="70%" width="80%" src="https://images.getstark.co/marketing/features/for-productmanagers-ticketing.webp?updatedAt=1706118938925"></img>

<div className="forDesigner-home3">
<h2 className='forDesigner-home3-h2-1'> <span style={{marginLeft:"25%"}}>Manage your</span> <span style={{marginLeft:"0%"}} className='forDesigner-home3-h2-1-2'><span >accessibility posture</span> </span> 
</h2>
<span style={{marginLeft:"27%"}} className='forDesigner-home3-h2-2'> across the entire organization</span>
<p style={{marginLeft:"25%",textAlign:'center',width:"40%"}} className='forDesigner-home3-h2-p'>
Addressing the issue of digital accessibility requires the same level of rigor and prioritization as security and privacy. With Stark’s compliance frameworks and controls, growing your company’s accessibility maturity finally becomes actionable.
</p>
...
{/*  */}
<img style={{marginTop:"-10%",marginLeft:"10%"}} height="70%" width="80%" src="https://images.getstark.co/marketing/features/continuous-accessibility-feature-2023.webp"></img>

<div className="forDesigner-home3">
<h2 className='forDesigner-home3-h2-2'>Real Time Insights to manage</h2>
<h2 className='forDesigner-home3-h2-1'> <h2 style={{marginLeft:"30%",marginTop:"-2%"}} className='forDesigner-home3-h2-1-2'><span >Comliance Reporting</span></h2>
</h2>
<p className='forDesigner-home3-h2-p' style={{fontSize:"1.5rem",marginLeft:"10%",textAlign:'center',width:"90%"}}>
Streamline collaboration across departments in one place with real-time accessibility scans of your design files, code repos, and live URLs. Managing digital accessibility at scale without slowing down your team’s velocity just got rocket fuel added to it.
</p>

<Link to="/pricing" style={{marginLeft:"42%",width:"15%"}} className='nav-btn-b1'>Get Started for free</Link>
</div>
{/*  */}
<img style={{marginTop:"-12%",marginLeft:"10%"}} height="70%" width="80%" src="https://images.getstark.co/marketing/features/for-productmanagers-framework.webp"></img>
<div className="forDesigner-home3">
<h2><span className='forDesigner-home3-h2-1' style={{marginLeft:"12%"}}> <span className='forDesigner-home3-h2-1-2'><span>Find and fix accessibility issues</span></span>
</span>
</h2>
<h2 className='forDesigner-home3-h2-2' style={{marginTop:'1%',marginLeft:"32%"}}> in designs 10x faster with AI
</h2>
<p className='forDesigner-home3-h2-p' style={{ fontSize:"1.3rem",marginLeft:"20%",textAlign:'center',width:"70%"}}>
57% of accessibility issues originate in the design phase. Sidekick in Stark automatically scans Figma or Sketch files and, within seconds, makes suggestions for how to fix the accessibility issues – no prior knowledge needed.
</p>
...
{/*  */}
<img style={{marginTop:"-12%",marginLeft:"10%"}} height="70%" width="80%" src="https://images.getstark.co/marketing/features/for-developers-devtooling.webp"></img>
<div className="forDesigner-home3">
<h2><span className='forDesigner-home3-h2-1' style={{marginLeft:"7%"}}> <span className='forDesigner-home3-h2-1-2'><span>Integrated, advanced</span></span><span>tooling that</span>
</span>
</h2>
<h2 className='forDesigner-home3-h2-2' style={{marginTop:'1%',marginLeft:"22%"}}> tooling that saves you up to 100x the dev cost</h2>
<p className='forDesigner-home3-h2-p' style={{marginLeft:"30%",textAlign:'center',width:"40%"}}>
Scan for accessibility issues as early as first lines of code. With continuous scanning in your repos as well as code highlighting in the browser, live preview to test fixes, and lightning fast WCAG audits, Stark’s integrated tools are web dev powerhouse.
</p>

<Link to="/pricing" style={{marginLeft:"42%",width:"15%"}} className='nav-btn-b1'>Get Started for free</Link>
</div>    
{/*  */}
<img style={{marginTop:"-12%",marginLeft:"10%"}} height="70%" width="80%" src="https://images.getstark.co/marketing/features/for-designers-checkfixannotate.webp"></img>
<div className="forDesigner-home3">
...
<div className ="fordesigner-set-icons" style={{marginTop:"-12%"}}>
...
export default ForComplianceManager