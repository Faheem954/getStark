...
<div className="forDesigner-home-2-img2">
  <img  src="https://images.getstark.co/marketing/headers/for-productmanagers.webp?updatedAt=1705447543866"></img>
</div>
</div>
...
<h2 className='forDesigner-home3-h2-1'> <span className='forDesigner-home3-h2-1-2'><span>Send issues directly</span> </span> <span>to your ticketing</span>
</h2>
<span style={{marginLeft:"20%"}} className='forDesigner-home3-h2-2'> System and track progress</span>
<p style={{marginLeft:"25%",textAlign:'center',width:"40%"}} className='forDesigner-home3-h2-p'>
Whether it’s a design file, code repo or live site – Send accessibility issues directly from Stark’s real-time reports as tickets to your projects in Asana, Jira, Trello, Azure DevOps, Bitbucket, Github Issues, GitLab, Linear and more.
</p>
...
<div className="forDesigner-home3">
<h2><span style={{marginLeft:"31%"}}>Manage your</span><span className='forDesigner-home3-h2-1' style={{marginLeft:'-19%'}}> <span className='forDesigner-home3-h2-1-2'><span>accessibility posture</span></span>
</span>
</h2>
<h2 className='forDesigner-home3-h2-2' style={{marginTop:'1%',marginLeft:"32%"}}> to keep your projects on track</h2>
<p className='forDesigner-home3-h2-p' style={{marginLeft:"30%",textAlign:'center',width:"40%"}}>
...
<h2 className='forDesigner-home3-h2-2' style={{marginTop:'1%',marginLeft:"32%"}}> in designs 10x faster with AI</h2>
<p className='forDesigner-home3-h2-p' style={{marginLeft:"30%",textAlign:'center',width:"40%"}}>
...
<div className="forDesigner-home3">
<h2><span className='forDesigner-home3-h2-1' style={{marginLeft:"12%"}}> <span className='forDesigner-home3-h2-1-2'><span>Integrated, advanced</span></span><span>tooling that</span>
</span>
</h2>
<h2 className='forDesigner-home3-h2-2' style={{marginTop:'1%',marginLeft:"32%"}}> tooling that saves you up to 100x the dev cost</h2>
<p className='forDesigner-home3-h2-p' style={{marginLeft:"30%",textAlign:'center',width:"40%"}}>
...
export default ForProductManager